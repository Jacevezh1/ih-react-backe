// Archivo para descifrar el token con nuestra llave, para sacar el dato del usuario, es un middleware de ruta, es como un route gard
// Es como un routeGard
// Con tokens ya no se usan cookies
